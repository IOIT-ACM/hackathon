...
const Countdown = () => {
	...
	return (
		<>
			<div className="relative flex  w-full overflow-hidden rounded-md bg-black/60 antialiased md:items-center md:justify-center">
				...
				<div className="relative z-10 mx-auto w-full max-w-7xl px-4">
					<div className="flex flex-col items-center justify-center p-2 sm:p-6 text-5xl sm:text-[100px] md:text-[125px] xl:text-[160px] font-gotham font-bold w-full bg-opacity-50 bg-linear-to-b from-neutral-50 to-neutral-400 bg-clip-text text-neutral-300 overflow-hidden min-h-screen">
