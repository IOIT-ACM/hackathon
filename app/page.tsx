    ...
    <div className="h-screen w-full flex flex-col">
      ...
      {enabled_interest ? <TenetHackForm /> :
        ...
        z-10 px-10'>
          ...
          <a className="relative cursor-pointer mt-2 px-10 py-2 text-lg font-medium text-black bg-[#141710] mx-auto hover:bg-primary-white hover:px-20 transition-all" href={process.env.REGISTRATION_LINK || ""}>
