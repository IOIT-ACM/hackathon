      ...
      {enabled_interest ? <TenetHackForm /> :
        ...
        z-10 px-10'>
          ...
          <div className="flex flex-row items-center justify-center gap-4">
            <a className="relative cursor-pointer mt-2 px-10 py-2 text-lg font-medium text-black bg-[#141710]  hover:bg-primary-white hover:px-20 transition-all" href={process.env.REGISTRATION_LINK || ""}>
            ...
            <a className="relative cursor-pointer mt-2 px-10 py-2 text-lg font-medium text-black bg-[#141710]  hover:bg-primary-white hover:px-20 transition-all" target="_blank" href={"https://discord.gg/dkVV2VDw"}>
