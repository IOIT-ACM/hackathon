...
const PrizeCard = ({
	...
	<div
		className={`flex flex-col items-center justify-center sm:-ml-8 lg:-ml-12 mt-8 sm:mt-28 ${
			prizeDescription == "2nd Prize"
				? "sm:order-1 order-2"
				: prizeDescription == "3rd Prize"
				? "sm:order-3 order-3"
	...
	>
		<div className="flex flex-col items-center justify-center xl:w-[460px]">
			...
			<div className="blur-[20px] -mt-6 -z-10 flex flex-col justify-center items-center">
				<div
					className={`md:w-[33vw] lg:w-[38vw] w-[98vw] sm:w-[36vw] h-[350px] lg:h-[500px] xl:h-[665px] bg-linear-to-b ${gradientColors} ${gradientClasses}`}
				></div>
			</div>
		</div>
		<div className="absolute flex flex-col items-center justify-center gap-3 mb-8 sm:mb-24">
			<AnimatedTitle>
				<Image src={cupImage} className="w-14 sm:w-18 lg:w-24" alt="cup" />{" "}
			</AnimatedTitle>
